...
public class QuestionPos2 : MonoBehaviour {
    ...
    void Update(){
     ...
     void checkforanswer(){
        ...
        Transform answer3child = gameObject.transform.Find("H2aswer3");
        Transform answer4child = gameObject.transform.Find("H2aswer4");
...
public void answeriswrong(string position)
{
    ...
    void positionChange(){
        ...
        GameObject auxOBJ = GameObject.Find("HolderPosition3");
        ...
        RunningGameDB.pos2Xcoord = 13.4f;
