...
public class QuestionPos3 : MonoBehaviour {
    ...
    void checkforanswer(){
        Transform answer1child = gameObject.transform.Find("H3aswer1");
        Transform answer2child = gameObject.transform.Find("H3aswer2");
        Transform answer3child = gameObject.transform.Find("H3aswer3");
        Transform answer4child = gameObject.transform.Find("H3aswer4");
        if (answer1child != null&&answer2child != null&&answer3child != null&&answer4child!=null)
        {
            ...
            rightanswer = GameObject.Find("H3aswer"+ QuestionCorrectAns);
        }
...
public void answeriswrong(string position)
{
    ...
    void positionChange(){
        ...
        GameObject auxOBJ2 = GameObject.Find("HolderPosition1");
       ...
       RunningGameDB.pos2Xcoord = 14.49f;
        RunningGameDB.pos3Xcoord = 13.4f;
        RunningGameDB.pos1Xcoord = 14.01f;
    }
    void TextCasetPosition(GameObject intrebare, GameObject raspuns1, GameObject raspuns2, GameObject raspuns3, GameObject raspuns4){
        // places the text in right position
